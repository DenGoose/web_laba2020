    ...
    <main role="main" class="f_main back_text">
        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <p>
                    Хакер Нео узнает, что его мир – виртуальный. Выдающийся экшен, доказавший, что зрелищное кино может
                    быть умным
                </p>
            ...
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/YihPA42fdQ8" frameborder="0"
