    ...
    <main role="main" class="f_main back_text">
        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <p>
                    Расформированная группа супергероев воссоединяется после смерти своего приемного отца, который
                    готовил их к спасению мира от неизвестной угрозы. Вместе они должны продолжить его дело.
                </p>
            ...
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/GlIIxTEmepU" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/cfo7fTiUfx4" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
        </div>
