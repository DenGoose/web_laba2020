...
<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
    ...
    <main role="main" class="f_main back_text">
        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                <p>
                    Постапокалиптическая охота за большими деньгами на территории зомби. Динамичный экшен, кровавые ужасы
                </p>
                ...
                <table class="table table-hover">
                    ...
                    <tr class="text-white">
                        <td>Жанр</td>
                        <td>триллер, драма, военный, биография</td>
                    </tr>
                    <tr class="text-white">
                        <td>Слоган</td>
                        <td>«Основано на невероятной, но реальной истории»</td>
                    </tr>
                    <tr class="text-white">
                        <td>Режиссер</td>
                        <td>Мортен Тильдум</td>
                    </tr>
                    <tr class="text-white">
                        <td>Премьера в Росcии</td>
                        <td>5 февраля 2015</td>
                    </tr>
                    <tr class="text-white">
                        <td>Премьера в мире</td>
                        <td>29 августа 2014</td>
                    </tr>
                    </tbody>
                </table>
            </div>
