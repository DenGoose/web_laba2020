        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <table class="table table-hover">
                    ...
                    <tr class="text-white">
                        <td>Жанр</td>
                        <td>ужасы, фантастика, фэнтези, триллер, драма, детектив</td>
                    </tr>
                    <tr class="text-white">
                        <td>Слоган</td>
                        <td>«The world is turning upside down»</td>
                    </tr>
                    <tr class="text-white">
                        <td>Режиссер</td>
                        <td>Мэтт Даффер, Росс Даффер, ...</td>
                    </tr>
                    <tr class="text-white">
            ...
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/PX6KNzyQfZM" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/q2zvKhUrg80" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/X15EmJFRUz0" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
        </div>
