    ...
    <main role="main" class="f_main back_text">
        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <p>
                    За 10 лет до начала истории, описанной в оригинальном сериале «Звёздный путь», экипаж корабля USS
                    Discovery NCC-1031 отправляется в путешествие, чтобы изучать глубокий космос и открыть новые миры и
                    цивилизации.
                </p>
            ...
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/qzGvfl9luFI" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/JoEsuRwiKQU" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/Dra45fWwYio" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
            </div>
        </div>
