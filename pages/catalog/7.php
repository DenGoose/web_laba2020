    ...
    <main role="main" class="f_main back_text">
        ...
        <div class="container-fluid container row text-center justify-content">
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <p>
                    Том Круз гибнет в бою с пришельцами, – но это только начало. Красивый экшен с хорошим юмором по
                    японской манге
                </p>
            ...
            <div class="col-xs-12 col-lg-12" style="margin-top: 20px">
                <iframe width="960" height="540" src="https://www.youtube.com/embed/HswBLVt8BEM" frameborder="0"
